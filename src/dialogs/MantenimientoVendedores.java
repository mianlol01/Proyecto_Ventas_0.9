...
public class MantenimientoVendedores extends DialogModelo {
	...
	private void agregarVendedor() {
		...
		if (!nombre.isEmpty() && !apellido.isEmpty() && !dni.isEmpty() && !telefono.isEmpty() && !categoria.isEmpty()) {
	...
	private void modificarVendedor() {
		if (!arregloVendedores.estaVacio()) {
			...
			if (selectedRow == -1) {
				...
				JTextField txtCategoria = new JTextField(vendedorSeleccionado.getCategoria());
